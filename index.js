...
function addTodo() {
  ...
  if (heading !== "") {
    ...
    //console.log("added ", todo, "in the list");
    todoItems.push(todo);
    toggle();
    goBack();
  }
...
function toggle() {
  ...
  if(flag)
  {
    ...
    //console.log("Flag value is true and background is homescreen")
  }
  else
  {
    blur = document.getElementById("blur-2");
    //console.log("Flag value is true and background is card screen")
  }
...
function goBack() {
  //This is the function by which we go back to home screen
  flag = true;
  renderTodo();
}